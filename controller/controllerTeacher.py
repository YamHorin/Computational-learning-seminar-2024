...
class controllerTeacher:
    ...
    def __init__(self, gui_app, pwd):
        self.app = gui_app
        self.sql_server = sql.sql_server('root', pwd, 'ai_question')

    def run_app(self):
        self.app.mainloop()
        self.get_ai_answers(self.app.questions, self.app.answers, self.app.key_words)

    def get_ai_answers(self, questions, answers, key_words):
